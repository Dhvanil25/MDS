        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-{{$v}}">
                ...
                <a href="/faculty/faculty_material_subject/{{$fs->semester_id}}/{{$fs->department_id}}/{{$fs->batch_id}}" class="small-box-footer">See Subjectt <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>           
            @endforeach
        </div>
