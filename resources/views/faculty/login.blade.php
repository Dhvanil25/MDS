...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('admin_public/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
  <!-- icheck bootstrap -->
...
<div class="login-box">
  ...
  <div class="card" >
    <div class="card-body login-card-body">
      <p class="login-box-msg"><b><label class="">VBTMCA Faculty</b></label></p>
...
<!-- AdminLTE App -->
<script src="{{asset('admin_public/dist/js/adminlte.min.js')}}"></script>
