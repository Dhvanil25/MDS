        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-{{$v}}">
                ...
                <a href="/faculty/faculty_program/{{$fs->semester_id}}/{{$fs->department_id}}/{{$fs->batch_id}}/{{$fs->subject_id}}" class="small-box-footer">Add Material <i class="fas fa-arrow-circle-right"></i></a>
              </div>
              @endif
            </div>           
            @endforeach
