      ...
      <div class="container-fluid">
        <!-- Small boxes (Stat box) -->
                ...
                <div class="card card-default">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                      {!! Form::open(['url'=>'admin/add_faculty','method'=>'POST','files' => true,'id'=>"quickForm","novalidate"=>"novalidate"]) !!}
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{ $i++}}</td>
                  <td>{{$fac->full_name}}</td>
                  <td><img height="50" width="50" src="{{asset('faculty_photos')}}/{{$fac->profile}}"></td>
                  <td>
                    <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#deleteModel{{$fac->id}}">
                      <i class="fas fa-trash"></i> Deletes
                      </button>
                      <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#editModel{{$fac->id}}">
                ...
                <!--Delete Model Start-->
                  <!-- Modal -->
                    <div class="modal fade" id="deleteModel{{$fac->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                {!! Form::model($fac, ['method'=>'DELETE','files' => true,'route' => ['add_faculty.destroy', $fac->id]]) !!}
                                    Are You Sure You Want to Delete <b>{{$fac->full_name}}</b> faculty
                            </div>
                ...
                {!! Form::close() !!}
                  ...
                  <!--Delete Model End-->
                  <!--Edit Model Start-->
                  <div class="modal fade" id="editModel{{$fac->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                          {!! Form::model($fac, ['method'=>'PATCH','files' => true,'route' => ['add_faculty.update', $fac->id]]) !!}
